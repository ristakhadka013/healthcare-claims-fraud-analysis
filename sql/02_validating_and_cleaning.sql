...
FROM inpatient;  
#HERE I FOUND THAT 3 FIELDS HAS MISSING VALUE WHILE LOADING DATA. 
# NOW LETS CHECK THE CSV TABLE HEADER WITH THE SQL FIELDS NAME 
# I FOUND THE ISSUE, WHILE IMPORTING THE DATA I READ THREE COLUMN INTO USER VARIABLE BUT IN SET CLAUSE I FORGOT TO ASSIGN 
